...
void window_sequence_remove_sub_window(SubWindow* sub_window, WindowSequence* sequence){
  sub_window_de_display(sequence->sub_window_array[sequence->current_window]);
  pointer_array_remove(WindowSequence->sub_window_array, sub_window, *sequence->num_sub_windows);
